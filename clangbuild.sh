...
clang++-3.6 -o bin/SwitchSingleB/node.o -c -Wall -std=c++11 -O3 src/SwitchSingleB/node.cpp
...
clang++-3.6 -o bin/perfTest bin/FnPtrBlockNode/node.o bin/SwitchBlockNode/node.o bin/FnPtrSingleNode/node.o bin/SwitchSingleNode/node.o bin/SwitchSingleB/node.o bin/perfTest.o
